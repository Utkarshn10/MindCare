          ...
          <div className="SubDivision">
            <div className="welcome-area text-area">
              ...
              <p className="timetext2">
                Set a time today to spend your anxiety credits by and check back
                with in with us! We'll help to re-evaluate your anxiety levels
                again.
              </p>
              <p className="timetext">Set a time today :</p>
              <KeyboardTimePickerExample />
              <div class="forbutton">
                <Link to="/Letsdoit" className="round-button timebutton">
                  Start Challenge
                </Link>
              </div>
            </div>
            <div className="welcome-area image-area">
              <img
                class="welcome-image"
                src="https://upload.wikimedia.org/wikipedia/commons/4/40/Alarm_Clock_Animation_High_Res.png"
              ></img>
            </div>
          </div>
        </div>
