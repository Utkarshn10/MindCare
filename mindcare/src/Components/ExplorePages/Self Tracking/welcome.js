        ...
        <div className="MainDivisionSid">
          <div className="SubDivision">
            <div className="welcome-area text-area">
              <h3 class="forh1">
                Welcome to the Self Assessment and Tracking Portal
              </h3>
              <p class="key-features">Key Features:</p>
              <ul>
                <li class="features">
                  It quantifies the difference in a user's actual and ideal
                  stress/anxiety/depression level
                </li>
                <li class="features">
                  Users then decide on the activities to spend their credits on,
                  the reward they get for completing them , and a time for
                  Portal to notify them to check back in.
                </li>
                <li class="features">
                  Using technology to aid issues centered around
                  stress/anxiety/depression.
                </li>
              </ul>
              <div class="forbutton">
                <Link to="/selectoption" className="round-button">
                  Get Started
                </Link>
              </div>
            </div>
