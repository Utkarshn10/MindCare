        ...
        <div className="MainDivisionSid">
          <div className="SubDivision">
            <div className="welcome-area text-area center">
              ...
              <p className="text2">
                Your objective is to spend all of it to bring your current
                anxiety level down to an ideal level before the day ends
              </p>
              ...
              <div class="center">
                <Link to="/Reward" className="round-button">
                  Next
                </Link>
              </div>
            </div>
