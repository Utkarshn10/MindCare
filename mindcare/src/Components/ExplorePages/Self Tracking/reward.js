        ...
        <div className="MainDivisionSid">
          <div className="SubDivision">
            <div className="welcome-area text-area">
              ...
              <p>
                We encourage you to pick a reward to award yourself with after
                you've spent your anxiety credits. This would reinforce the
                positive habit of dealing with anxiety in an actionable manner
              </p>
              ...
              <div class="forbutton">
                <Link to="/CheckBack" className="round-button">
                  Next
                </Link>
              </div>
            </div>
            <div className="welcome-area image-area">
              <img
                class="welcome-image"
                src="http://cdn.lowgif.com/full/3b8b17ede04086d7-reward-badges-by-mayank-dhawan-dribbble.gif"
              ></img>
            </div>
          </div>
        </div>
